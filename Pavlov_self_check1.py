...
print('№1 ' + str(fio == ['Павлов', 'Георгий', 'Эдуардович']))
...
"""------------ конец блока редактирования----------------"""
print('№7 ' + str(surname_list == ['П', 'а', 'в', 'л', 'о', 'в']))
...
"""------------ конец блока редактирования----------------"""
print('№8 ' + str(surname_tuple == ('П', 'а', 'в', 'л', 'о', 'в')))
...
"""------------ конец блока редактирования----------------"""
print('№10 ' + str(res == [(0, 'П'), (1, 'а'), (2, 'в'), (3, 'л'), (4, 'о'), (5, 'в')]))
